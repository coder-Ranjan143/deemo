 ...
 return (
    <div className="min-h-screen bg-[#f5f6fa] p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5 mt-7">
        ...
        {/* TOTAL CALLS */}
        <div className="bg-white border-l-4 border-blue-500 rounded-2xl p-6 shadow-sm  cursor-pointer   "
                                onClick={() => navigate("/callcenter/list")}
>
        ...
        {/* RESOLVED */}
        <div className="bg-white border-l-4 border-green-500 rounded-2xl p-6 shadow-sm cursor-pointer "   onClick={() => navigate("/callCenter/list-Resolved" )}>
        ...
        {/* PENDING */}
        <div className="bg-white border-l-4 border-yellow-500 rounded-2xl p-6 shadow-sm cursor-pointer  "  onClick={() => navigate("/callCenter/pending" )} >
        ...
        {/* AVG HANDLE TIME */}
        <div className="bg-white border-l-4 border-purple-500 rounded-2xl p-6 shadow-sm cursor-pointer "  onClick={() => navigate("/callCenter/statusList"  )}>
