...
function InTransit() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-100 p-6 mt-35">
            ...
            <div className="bg-white rounded-2xl shadow overflow-hidden">
              ...
              <div className="p-5 space-y-4">
                ...
                <div className="bg-green-100 rounded-xl p-5 flex items-center gap-4">
                  ...
                  <div
                    onClick={() => navigate("/in-Transit/vehicleRunningWithPass")}
                ...
                <div className="bg-red-100 rounded-xl p-5 flex items-center gap-4">
                  ...
                  <div
                    onClick={() => navigate("/in-Transit/runningWithexpiredTpPass")}
                    className="cursor-pointer"
                  >
                    <div>
                      <h2 className="font-semibold text-gray-700">
