  ...
  return (
    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
      <h1 className="text-2xl font-bold text-blue-700">
        Manufacturing Unit Average Bottling Hours
        <p className="text-sm text-gray-500">Daily configured bottling hours for manufacturing units</p>
      </h1>
      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <div className="flex-item-center gap-2 bg-slate-50 border border-slate-300 text-slate-700 text-sm rounded-md px-4 py-2.5 shadow-sm">
          <strong>Total:</strong>
          " 3"
        </div>
        <div className="flex-item-center gap-2 bg-amber-50 border border-amber-300 text-amber-700 text-sm rounded-md px-4 py-2.5 shadow-sm">
          <strong>Average:</strong>
          " 13m"
        </div>
        {/* <div className="flex-item-center gap-2 bg-rose-50 border border-rose-300 text-rose-700 text-sm rounded-md px-4 py-2.5 shadow-sm">
          <strong>Long:</strong>
          " 245"
        </div> */}
